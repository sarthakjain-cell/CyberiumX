      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        <motion.div
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 10px 40px rgba(252, 22, 22, 0.05)';
          }}
          onMouseLeave={(e) => {
        ...
        >
          <h3 style={{ fontSize: '2rem', color: '#fff', marginBottom: '1.5rem', position: 'relative', display: 'inline-block' }}>
            7-Layer Protection
            <div style={{ position: 'absolute', bottom: '-10px', left: 0, width: '40px', height: '3px', background: 'var(--primary)', borderRadius: '2px' }}></div>
          </h3>
          ...
          <Link href="/services" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
            Explore 7X-Security
        ...
        >
          ...
          <Link href="/global-services" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
